...
String localizedFailure(Failure? failure) {
  return switch (failure) {
    ...
    TransferNotSettleableFailure() => t.errors.transferNotSettleable,
    TargetsMustSumTo100Failure() => t.errors.targetsMustSumTo100,
    CategoryHasSubcategoriesFailure() => t.errors.categoryHasSubcategories,
