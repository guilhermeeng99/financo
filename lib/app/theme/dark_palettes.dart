...
// Dark-mode palette catalog. Mirrors light_palettes.dart and is selected
// independently — a user might prefer Indigo light + Pure Black dark.
enum DarkPalette {
  midnightIndigo,
  forestNight,
  crimsonEmber,
