...
class _Translations$errors$pt_BR implements Translations$errors$en {
	...
	@override String get transferNotSettleable => 'Uma transferência não pode ser agendada como conta a pagar.';
	@override String get targetsMustSumTo100 => 'Os percentuais precisam somar 100% e ser não-negativos.';
	@override String get categoryHasSubcategories => 'Exclua ou mova as subcategorias antes de excluir esta categoria.';
}
...
class _Translations$fiftyThirtyTwenty$pt_BR implements Translations$fiftyThirtyTwenty$en {
	...
	@override String get tipSavingsShortNoAccount => 'Cadastre a corretora onde você investe para começar a registrar seus aportes.';
	@override String tipUnclassified({required Object count}) => '${count} categoria(s) ainda sem classificação.';
	@override String get ctaCreateInvestment => 'Cadastrar instituição';
...
class _Translations$categories$pt_BR implements Translations$categories$en {
	...
	@override String get bucketHelp => 'Necessidades cobrem o essencial (aluguel, mercado, transporte). Desejos cobrem o discricionário (lazer, restaurantes). Investimento é contado pelos aportes nas suas corretoras, não por categoria.';
...
class _Translations$investing$institutions$pt_BR implements Translations$investing$institutions$en {
	_Translations$investing$institutions$pt_BR._(this._root);

	final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Instituições';
	@override String get emptyTitle => 'Nenhuma instituição ainda';
	@override String get empty => 'Adicione onde você custodia seus investimentos (Nubank, Avenue, …).';
	@override String get addFirst => 'Adicionar instituição';
	@override String get add => 'Nova instituição';
	@override String get edit => 'Editar instituição';
	@override String get name => 'Nome';
	@override String get nameHint => 'Nubank, Avenue, Wise…';
	@override String get kind => 'Tipo';
	@override String get currency => 'Moeda padrão';
	@override String get created => 'Instituição criada';
	@override String get updated => 'Instituição atualizada';
	@override String get deleted => 'Instituição removida';
	@override String get deleteConfirm => 'Remover esta instituição?';
...
class _Translations$investing$transactions$pt_BR implements Translations$investing$transactions$en {
	...
	@override String get funding => 'Movimentação de caixa';
	@override String get fundingDebit => 'Debitado de';
	@override String get fundingCredit => 'Creditado em';
	@override String get fundingNone => 'Nenhuma — dinheiro ficou na corretora';
	@override String get fundingHint => 'Escolha a conta só se o dinheiro realmente se moveu. O aporte/resgate correspondente é lançado automaticamente.';
	@override String get cashAmount => 'Valor movimentado';
...
class _Translations$investing$institutions$kinds$pt_BR implements Translations$investing$institutions$kinds$en {
	_Translations$investing$institutions$kinds$pt_BR._(this._root);

	final TranslationsPtBr _root; // ignore: unused_field

	// Translations
	@override String get bank => 'Banco';
	@override String get broker => 'Corretora';
	@override String get internationalBroker => 'Corretora internacional';
	@override String get crypto => 'Exchange de cripto';
...
extension on TranslationsPtBr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'errors.transferNotSettleable' => 'Uma transferência não pode ser agendada como conta a pagar.',
			'errors.targetsMustSumTo100' => 'Os percentuais precisam somar 100% e ser não-negativos.',
			'errors.categoryHasSubcategories' => 'Exclua ou mova as subcategorias antes de excluir esta categoria.',
			...
			'investing.institutions.title' => 'Instituições',
			'investing.institutions.emptyTitle' => 'Nenhuma instituição ainda',
			'investing.institutions.empty' => 'Adicione onde você custodia seus investimentos (Nubank, Avenue, …).',
			'investing.institutions.addFirst' => 'Adicionar instituição',
			'investing.institutions.add' => 'Nova instituição',
			'investing.institutions.edit' => 'Editar instituição',
			'investing.institutions.name' => 'Nome',
			'investing.institutions.nameHint' => 'Nubank, Avenue, Wise…',
			'investing.institutions.kind' => 'Tipo',
			'investing.institutions.currency' => 'Moeda padrão',
			'investing.institutions.created' => 'Instituição criada',
			'investing.institutions.updated' => 'Instituição atualizada',
			'investing.institutions.deleted' => 'Instituição removida',
			'investing.institutions.deleteConfirm' => 'Remover esta instituição?',
			'investing.institutions.kinds.bank' => 'Banco',
			'investing.institutions.kinds.broker' => 'Corretora',
			...
			'investing.transactions.funding' => 'Movimentação de caixa',
			'investing.transactions.fundingDebit' => 'Debitado de',
			'investing.transactions.fundingCredit' => 'Creditado em',
			'investing.transactions.fundingNone' => 'Nenhuma — dinheiro ficou na corretora',
			'investing.transactions.fundingHint' => 'Escolha a conta só se o dinheiro realmente se moveu. O aporte/resgate correspondente é lançado automaticamente.',
			'investing.transactions.cashAmount' => 'Valor movimentado',
			...
			'fiftyThirtyTwenty.tipSavingsShortNoAccount' => 'Cadastre a corretora onde você investe para começar a registrar seus aportes.',
			'fiftyThirtyTwenty.tipUnclassified' => ({required Object count}) => '${count} categoria(s) ainda sem classificação.',
			'fiftyThirtyTwenty.ctaCreateInvestment' => 'Cadastrar instituição',
			...
			'categories.bucketHelp' => 'Necessidades cobrem o essencial (aluguel, mercado, transporte). Desejos cobrem o discricionário (lazer, restaurantes). Investimento é contado pelos aportes nas suas corretoras, não por categoria.',
