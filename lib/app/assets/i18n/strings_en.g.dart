...
class Translations$errors$en {
	...
	/// en: 'A transfer can't be scheduled as a payable.'
	String get transferNotSettleable => 'A transfer can\'t be scheduled as a payable.';

	/// en: 'The percentages must add up to 100% and can't be negative.'
	String get targetsMustSumTo100 => 'The percentages must add up to 100% and can\'t be negative.';

	/// en: 'Delete or move the subcategories before deleting this category.'
	String get categoryHasSubcategories => 'Delete or move the subcategories before deleting this category.';
}
...
class Translations$fiftyThirtyTwenty$en {
	...
	/// en: 'Add the broker you invest through to start logging contributions.'
	String get tipSavingsShortNoAccount => 'Add the broker you invest through to start logging contributions.';
	...
	/// en: 'Add institution'
	String get ctaCreateInvestment => 'Add institution';
...
class Translations$categories$en {
	...
	/// en: 'Needs cover essentials (rent, groceries, transport). Wants cover discretionary (leisure, dining out). Savings is counted from contributions to your brokers, not from a category.'
	String get bucketHelp => 'Needs cover essentials (rent, groceries, transport). Wants cover discretionary (leisure, dining out). Savings is counted from contributions to your brokers, not from a category.';
...
class Translations$investing$transactions$en {
	...
	/// en: 'Cash movement'
	String get funding => 'Cash movement';

	/// en: 'Debited from'
	String get fundingDebit => 'Debited from';

	/// en: 'Credited to'
	String get fundingCredit => 'Credited to';

	/// en: 'None — money stayed at the broker'
	String get fundingNone => 'None — money stayed at the broker';

	/// en: 'Pick the account only if money actually moved. We record the matching aporte/resgate for you.'
	String get fundingHint => 'Pick the account only if money actually moved. We record the matching aporte/resgate for you.';

	/// en: 'Amount moved'
	String get cashAmount => 'Amount moved';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'errors.transferNotSettleable' => 'A transfer can\'t be scheduled as a payable.',
			'errors.targetsMustSumTo100' => 'The percentages must add up to 100% and can\'t be negative.',
			'errors.categoryHasSubcategories' => 'Delete or move the subcategories before deleting this category.',
			...
			'investing.transactions.funding' => 'Cash movement',
			'investing.transactions.fundingDebit' => 'Debited from',
			'investing.transactions.fundingCredit' => 'Credited to',
			'investing.transactions.fundingNone' => 'None — money stayed at the broker',
			'investing.transactions.fundingHint' => 'Pick the account only if money actually moved. We record the matching aporte/resgate for you.',
			'investing.transactions.cashAmount' => 'Amount moved',
			...
			'fiftyThirtyTwenty.tipSavingsShortNoAccount' => 'Add the broker you invest through to start logging contributions.',
			'fiftyThirtyTwenty.tipUnclassified' => ({required Object count}) => '${count} category(ies) still need classification.',
			'fiftyThirtyTwenty.ctaCreateInvestment' => 'Add institution',
			...
			'categories.bucketHelp' => 'Needs cover essentials (rent, groceries, transport). Wants cover discretionary (leisure, dining out). Savings is counted from contributions to your brokers, not from a category.',
